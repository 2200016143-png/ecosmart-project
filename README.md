...
| Komponen | Keterangan |
| :--- | :--- |
| **Mobile Layer** | [cite_start]Aplikasi Flutter yang berjalan di platform Android [cite: 72] |
| **UI Layer** | [cite_start]Widget-based UI menggunakan Material Design 3 [cite: 72] |
| **State Management** | [cite_start]StatefulWidget & StatelessWidget bawaan Flutter [cite: 72] |
